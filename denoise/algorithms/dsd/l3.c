...
void compute_l3_score(const void * p_neighbors, const void * q_neighbors, int size_pn, int size_qn, const void * edge_matrix, const void * n_degrees, int no_nodes, void * out) {
